    ...
    <RightContentWrapper>
      ...
      >
        <Tilt
          ...
          transitionSpeed={400}
        >
          <div className="bg-card border border-gray-700 p-4 rounded-2xl shadow-md overflow-hidden hover:scale-[1.02] transition pointer-events-none section-glimmer">
