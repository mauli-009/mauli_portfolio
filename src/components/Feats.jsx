      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 overflow-hidden">
        {achievements.map((feat, idx) => (
          ...
          <motion.div
            ...
            className="border border-white/20 rounded-xl p-6 flex flex-col items-center bg-gray-900 backdrop-blur-md shadow-lg hover:scale-[1.02] transition cursor-pointer section-glimmer"
          >
            <img
              src={feat.icon}
              alt={feat.title}
